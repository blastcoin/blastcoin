...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 8606 or testnet: 18606)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 8605 or testnet: 18605)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Blastcoin Wiki for SSL setup instructions)") + "\n" +
