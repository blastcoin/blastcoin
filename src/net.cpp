...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Blastcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"blastcoin.com", "seed.blastcoin.com"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"blastcoin.com", "testnet-seed.blastcoin.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Blastcoin is probably already running."), addrBind.ToString().c_str());
        else
